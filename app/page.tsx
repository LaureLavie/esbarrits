...
import gurs from '../public/images/gurs.webp';
import cardesse from '../public/images/cardesse.webp';
...
export default function Page() {
  ...
  const sampleEvent = [
    { id: 1, date: 'Samedi 01 Août 2026', location: 'Au Chalet à Salies de Béarn', time: '20h', price: 'Libre participation', description: 'Animation Repas', image: chalet },
    { id: 2, date: 'Vendredi 07 Août', location: 'Animation du Marché de Cardesse', time: '17h', price: 'Gratuit', description: 'Animation & chant', image: cardesse },
    { id: 3, date: 'Samedi 28 Août', location: 'Gurs', time: '19h', price: 'Gratuit', description: 'Soirée Animation tapas', image: gurs },
   // { id: 4, date: 'Dimanche 07 Juin', location: 'à Monein', time: '--', price: 'Libre participation', description: 'Animation & Concert', image: groupe },
   // { id: 5, date: 'Du 11 au 18 juin 2026', location: 'Allemagne', time: 'Toute la semaine', price: 'Libre participation', description: 'Animation & Concert en Allemagne', image: choraleallemande },
   // { id: 6, date: 'Mardi 28 Juillet', location: 'Au Domaine Bayard à Monein', time: 'Soirée', price: 'Soirée privée', description: 'Animation repas', image: domaine_bayard },
