...
export default function Page() {
  ...
  const sampleEvent = [
    ...
    { id: 2, date: 'Jeudi 04 Juin', location: 'Au Domaine Bayard à Monein', time: '12h', price: 'Libre participation', description: 'Animation repas', image: domaine_bayard },
    ...
    { id: 5, date: 'Mardi 28 Juillet', location: 'Au Domaine Bayard à Monein', time: 'Soirée', price: 'Libre participation', description: 'Animation repas', image: domaine_bayard },
    ...
    { id: 7, date: 'Mercredi 09 Septembre 2026', location: 'Au Domaine Bayard à Monein', time: '12h', price: 'Libre participation', description: 'Animation Repas', image: domaine_bayard },
