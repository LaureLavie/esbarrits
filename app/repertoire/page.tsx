  ...
  return (
    <div>
      ...
      <main className="repertoire-page">
        ...
        <section className="repertoire-text">
          <p>
            Il nous fallait illustrer le thème “Passa lo temps” (le temps passe)
            pour composer la jaquette de notre CD. Pour cela, nous avons utilisé
            deux photos de notre village, qui sont à elles seules des
            témoignages frappants de ce temps qui passe…  
          </p>
          <p>
            Celle-ci, datant du
            début du XXème siècle montre la Place de la Liberté avec son chêne
            multi-centenaire. Vous noterez la “vitalité” du village, ne
            serait-ce que par la présence “massive” des habitants… (On aurait
            sans doute beaucoup de mal à rassembler autant de “villageois”
            aujourd’hui pour la photo !!!)
          </p>
          <p>
              Et oui, le temps passe et notre
            village a été, comme tous les villages ruraux, victime du
            dépeuplement, de l’exode rural. Comme les autres, il a vu
            disparaître ses nombreux commerces, artisans et services… Mais il
            faut garder espoir et surtout sauvegarder notre patrimoine culturel.
            C’est la motivation profonde de notre groupe: garder bien vivantes
            nos belles chansons traditionnelles, les préserver de l’oubli dans
